...
mov eax, stackstart
mov currptr, eax ; currptr = stackstart
...
add index, 1h ; index = index + 1
sub currptr, 1h ; currptr = currptr - 1
	
cmp index, eax  ; If index == k+n
jne label_1
mov index, 0 ; index = 0
label_1:
...
mov eax, tempvar
cmp currptr, eax ;  If currptr > stackstart-150
